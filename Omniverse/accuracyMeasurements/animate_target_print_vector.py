...
class TargetControl(BehaviorScript):
    def on_init(self):
        ...
        with open("C:/Users/halle/Documents/DigitalTwin/Performance/accuracy/Output/path_data/output.txt") as f:
    ...
    def on_play(self):
        ...
        self.filestream = open("C:/Users/halle/Documents/DigitalTwin/Performance/accuracy/Output/endpoints/vector.txt", "w", encoding="utf-8")
    ...
    def on_update(self, current_time: float, delta_time: float):
        ...
        if self.waiting is False and self.time_step < len(self.lines) - 1:
            ...
            data = self.lines[self.time_step] + ";" + str(self.v_endpoint.Get()) + ";" + str(self.r_endpoint.Get()) + "\n"
