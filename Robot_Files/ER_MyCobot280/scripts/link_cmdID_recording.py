...
# with a time delay for prevent rapid commands
# Authors: Athena Angara and Hal Brynteson
#
...
def main():
    ...
    filestream = open("/home/er/py_scripts/Recordings/real_arm_recv.txt", "w", encoding="utf-8")
    ...
    while True:
        try:
            ...
            if(sendAngles):
                ...
                sendAngles = False
                printData = str(cmdID) + ";" + str(datetime.datetime.now()) + ";" +  str(message_arr) + "\n"
