...
init_angles = [0, 0, 0, 0, 0, 0, 0]  # zero point
...
socket.connect('tcp://192.168.1.239:12346')
    ...
    while True:
        try:
            ...
            if(sendAngles):
                ...
                if(sendGrip):
                    #print("grip" + str(grip_state))
                    mc.set_gripper_state(int(grip_state), 80)
